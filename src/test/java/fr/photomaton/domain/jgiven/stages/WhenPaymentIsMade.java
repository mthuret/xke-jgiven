...
public class WhenPaymentIsMade<SELF extends WhenPaymentIsMade<?>> extends Stage<SELF> {
    ...
    public SELF not_enough_euros_is_given_to_the_photomaton() {
    ...
    public SELF more_euros_than_the_price_of_the_wanted_picture_is_given_to_the_photomaton() throws URISyntaxException {
        final Order order = aDefaultOrder()
